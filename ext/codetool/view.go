...
func View(opts ...Option) core.Tool {
	...
	return core.FuncTool[ViewParams](
		...
		func(ctx context.Context, params ViewParams) (string, error) {
			...
			// Warn about auto-generated source files. These have markers like
			// "DO NOT EDIT" or "Code generated" in the first few lines. Editing
			// them is futile — the agent should find the source template/schema
			// and regenerate, or edit the generator input instead.
			if lineNum > 0 && offset <= 1 && isGeneratedFile(lines) {
				result += "\n[hint: this file appears to be auto-generated (contains 'DO NOT EDIT' " +
					"or similar marker). Edits will be overwritten by the code generator. " +
					"Find and modify the source (proto, schema, template) instead, " +
					"or edit the generator configuration.]"
			}
...
// isGeneratedFile checks whether the file's first few lines contain markers
// indicating it was auto-generated by a code generator. Common markers include
// "DO NOT EDIT", "Code generated by", "@generated", etc. These files should
// not be edited directly — the agent should modify the source (proto, schema,
// template) and regenerate instead.
func isGeneratedFile(lines []string) bool {
	// Check the first 5 lines for generation markers.
	limit := 5
	if len(lines) < limit {
		limit = len(lines)
	}
	for _, line := range lines[:limit] {
		...
		if strings.Contains(upper, "DO NOT EDIT") ||
			strings.Contains(upper, "GENERATED BY") ||
			strings.Contains(upper, "AUTO-GENERATED") ||
			strings.Contains(upper, "AUTOGENERATED") ||
			strings.Contains(upper, "@GENERATED") ||
			strings.Contains(upper, "CODE GENERATED") ||
			strings.Contains(upper, "THIS FILE IS GENERATED") ||
			strings.Contains(upper, "AUTOMATICALLY GENERATED") {
			return true
		}
	}
	return false
