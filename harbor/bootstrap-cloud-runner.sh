...
export GOLLEM_SETUP_PYTHON_PACKAGES="pytest numpy scipy pandas statsmodels scikit-learn requests pyyaml matplotlib pillow sympy beautifulsoup4 huggingface-hub cachetools"
