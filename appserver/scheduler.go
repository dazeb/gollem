...
func RequestScheduleFor(method string, params json.RawMessage) RequestSchedule {
	_ = params
	switch method {
	case "thread/list", "thread/search", "thread/loaded/list", "thread/unsubscribe", "thread/read", "thread/fork", "thread/compact/start", "thread/rollback", "thread/archive", "thread/unarchive", "thread/delete", "thread/settings/update",
