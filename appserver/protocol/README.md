...
`typescript/testdata/thread_lifecycle_notification_wire_v1.ts`. Tests compare
...
goals, metadata, and lifecycle notifications.
...
delete, and unarchive notifications. Consumers can use
