...
func TestPermissionProfilePublicValuesRejectMalformedInput(t *testing.T) {
	tests := []struct {
		...
		{"access wrong type", `1`, func() any { return new(FileSystemAccessMode) }},
		{"invalid access", `"execute"`, func() any { return new(FileSystemAccessMode) }},
		{"path malformed", `{`, func() any { return new(FileSystemPath) }},
		{"path null", `null`, func() any { return new(FileSystemPath) }},
		{"path missing type", `{"path":"workspace"}`, func() any { return new(FileSystemPath) }},
		{"path invalid type", `{"type":"mount","path":"workspace"}`, func() any { return new(FileSystemPath) }},
		...
		{"null glob", `{"type":"glob_pattern","pattern":null}`, func() any { return new(FileSystemPath) }},
		{"malformed special value", `{"type":"special","value":1}`, func() any { return new(FileSystemPath) }},
		{"path unknown", `{"type":"glob_pattern","pattern":"*.go","extra":true}`, func() any { return new(FileSystemPath) }},
		{"special malformed", `{`, func() any { return new(FileSystemSpecialPath) }},
		{"special null", `null`, func() any { return new(FileSystemSpecialPath) }},
		{"special missing kind", `{"path":"/"}`, func() any { return new(FileSystemSpecialPath) }},
		{"special invalid kind", `{"kind":"workspace"}`, func() any { return new(FileSystemSpecialPath) }},
		{"special unknown", `{"kind":"root","path":"/"}`, func() any { return new(FileSystemSpecialPath) }},
		{"project subpath wrong type", `{"kind":"project_roots","subpath":1}`, func() any { return new(FileSystemSpecialPath) }},
		{"unknown special missing path", `{"kind":"unknown"}`, func() any { return new(FileSystemSpecialPath) }},
		{"null unknown special path", `{"kind":"unknown","path":null}`, func() any { return new(FileSystemSpecialPath) }},
		{"unknown special subpath wrong type", `{"kind":"unknown","path":"/","subpath":1}`, func() any { return new(FileSystemSpecialPath) }},
		{"scope wrong type", `{"permissions":{},"scope":1}`, func() any { return new(PermissionsRequestApprovalResponse) }},
