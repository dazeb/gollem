...
func TestToolListAvailability(t *testing.T) {
	...
	if !containsMethod(processTool.Methods, "thread/shellCommand") || !containsMethod(processTool.Methods, "thread/backgroundTerminals/list") || !containsMethod(processTool.Methods, "thread/backgroundTerminals/read") || !containsMethod(processTool.Methods, "thread/backgroundTerminals/write") || !containsMethod(processTool.Methods, "thread/backgroundTerminals/clean") {
